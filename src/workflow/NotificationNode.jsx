...
import { Handle, Position } from '@xyflow/react';
 ...
 const ColorSelectionNode = ({ data, isConnectable, id, type }) => {
  ...
  return (
    <>
      ...
      <ul className="w-48 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        <li className="w-full px-4 py-2 border-b border-gray-200 rounded-t-lg rounded-b-lg dark:border-gray-600">{data?.text} via {data?.medium}</li>
      </ul>
      </div>
      <Handle
        type="source"
...
export default memo(ColorSelectionNode);